...
enum WeatherCondition: String, Codable {
    ...
    var localizedDisplayName: String {
        ...
        let names: [String: [WeatherCondition: String]] = [
            ...
            "pt": [.sunny: "Ensolarado", .partlyCloudy: "Parcialmente nublado", .cloudy: "Nublado", .overcast: "Encoberto", .lightRain: "Chuva fraca", .rain: "Chuva", .heavyRain: "Chuva forte", .thunderstorm: "Trovoada", .snow: "Neve", .sleet: "Aguaneve", .fog: "Nevoeiro", .windy: "Ventoso", .hail: "Granizo"],
            "nl": [.sunny: "Zonnig", .partlyCloudy: "Half bewolkt", .cloudy: "Bewolkt", .overcast: "Zwaar bewolkt", .lightRain: "Lichte regen", .rain: "Regen", .heavyRain: "Hevige regen", .thunderstorm: "Onweer", .snow: "Sneeuw", .sleet: "Natte sneeuw", .fog: "Mist", .windy: "Winderig", .hail: "Hagel"],
            ...
            "ko": [.sunny: "맑음", .partlyCloudy: "구름 조금", .cloudy: "흐림", .overcast: "잔뜩 흐림", .lightRain: "약한 비", .rain: "비", .heavyRain: "폭우", .thunderstorm: "뇌우", .snow: "눈", .sleet: "진눈깨비", .fog: "안개", .windy: "바람", .hail: "우박"],
            "zh": [.sunny: "晴", .partlyCloudy: "局部多云", .cloudy: "多云", .overcast: "阴", .lightRain: "小雨", .rain: "雨", .heavyRain: "大雨", .thunderstorm: "雷暴", .snow: "雪", .sleet: "雨夹雪", .fog: "雾", .windy: "有风", .hail: "冰雹"],
            "ar": [.sunny: "مشمس", .partlyCloudy: "غائم جزئياً", .cloudy: "غائم", .overcast: "ملبد بالغيوم", .lightRain: "مطر خفيف", .rain: "مطر", .heavyRain: "مطر غزير", .thunderstorm: "عاصفة رعدية", .snow: "ثلج", .sleet: "مطر ثلجي", .fog: "ضباب", .windy: "عاصف", .hail: "بَرَد"],
            "hi": [.sunny: "धूप", .partlyCloudy: "आंशिक बादल", .cloudy: "बादल", .overcast: "घना बादल", .lightRain: "हल्की बारिश", .rain: "बारिश", .heavyRain: "भारी बारिश", .thunderstorm: "आंधी-तूफान", .snow: "बर्फ", .sleet: "ओले-बारिश", .fog: "कोहरा", .windy: "हवादार", .hail: "ओले"],
            "uk": [.sunny: "Сонячно", .partlyCloudy: "Мінлива хмарність", .cloudy: "Хмарно", .overcast: "Похмуро", .lightRain: "Невеликий дощ", .rain: "Дощ", .heavyRain: "Сильний дощ", .thunderstorm: "Гроза", .snow: "Сніг", .sleet: "Мокрий сніг", .fog: "Туман", .windy: "Вітряно", .hail: "Град"],
            "ru": [.sunny: "Солнечно", .partlyCloudy: "Переменная облачность", .cloudy: "Облачно", .overcast: "Пасмурно", .lightRain: "Лёгкий дождь", .rain: "Дождь", .heavyRain: "Сильный дождь", .thunderstorm: "Гроза", .snow: "Снег", .sleet: "Дождь со снегом", .fog: "Туман", .windy: "Ветрено", .hail: "Град"],
        ]
